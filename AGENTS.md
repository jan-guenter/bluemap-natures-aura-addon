# Agent guide for the Nature's Aura BlueMap add-on
...
- Exact profile `naturesaura-41.9-mc1.21.1`
...
Scaffold placeholders are permitted only during the fast prototype phase.
The release gate rejects it.

## Commands

Compile and test the exact migration candidate:
