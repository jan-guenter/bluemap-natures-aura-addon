...
package io.github.janguenter.bluemap.naturesaura;

import io.github.janguenter.bluemap.naturesaura.adapter.bluemap522.AdapterCompatibility;

import java.lang.reflect.InvocationTargetException;
import java.lang.reflect.Method;

/** BlueMap add-on entrypoint installed before resource-pack construction. */
public final class BlueMapNaturesAuraAddon implements Runnable {
    ...
    public void run() {
        try {
            ...
            Class<?> adapter = Class.forName(
                    "io.github.janguenter.bluemap.naturesaura.adapter.bluemap522.BlueMap522Adapter",
                    true,
                    BlueMapNaturesAuraAddon.class.getClassLoader()
            );
    ...
    private static void inactive(String reason, Throwable cause) {
        ...
        System.err.println("BlueMap Nature's Aura add-on is inactive: "
                + reason + detail + '.');
    }
}
